...
<div class="bg-gray-300 max-w-screen-md mx-auto border rounded">
    <h1 class="text-2xl text-center mt-5 pt-5 uppercase">Nueva Vacante</h1>
    ...
    @csrf 
            ...
            <div class="">
                ...
                <input 
                    type="text" name="titulo" id="titulo" class="p-3 bg-withe rounded form-input w-full" placeholder="Titulo de la Vacante" value="{{old('titulo')}}">
            ...
            <div class="mb-5">
             ...
             <div class="mb-5">
                ...
                <lista-skills
                    :skills="{{json_encode($skills)}}" :oldskills="{{json_encode(old('skills'))}}"
                ></lista-skills>
           ...
           const dropzoneDevJobs = new Dropzone('#dropzoneDevJobs', {
               ...
               removedfile: function(file, response){
                ...
                file.previewElement.parentNode.removeChild(file.previewElement); //funcion para eliminar las imagenes anteriores del DOM
                   ...
                   params = {
                        imagen: file.nombreServidor ?? document.querySelector('#imagen')
                   }
