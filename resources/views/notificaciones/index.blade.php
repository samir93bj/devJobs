        ...
        <ul class="max-w-md mx-auto mt-10">
            @foreach ($notificaciones as $notificacion)
                ...
                <li class="p-5 border border-gray-400 mb-5">
                    ...
                    <p class="mb-4">
                        Te escribio: <span class="font-bold">{{ $notificacion->created_at->diffForHumans() }}</span>
                    </p>
                    <a href="{{ route('candidatos.index',['id'=>$data['id_vacante']]) }}" class="bg-gray-600 p-3 inline-block text-sm font-bold uppercase text-white mb-4">
                        Ver Candidatos
                    </a>
                </li>
            @endforeach
