    ...
    <div class="container mx-auto max-w-screen-md">
        <div class="flex flex-wrap justify-center">
            <div class="md:w-1/2">
                ...
                <div class="w-full max-w-sm">
                    <div class="flex flex-col break-words bg-white border border-2 shadow-md">
                        <div class="bg-gray-300 text-gray-900 uppercase text-center py-3 px-6 mb-0">{{ __('Register') }}</div>
        
                            <form class="py-10 px-5" method="POST" action="{{ route('register') }}">
                                @csrf
        
                                <div class="flex flex-wrap mb-6">
                                    <label for="name" class="block text-gray-90 text-md mb-2">{{ __('Name') }}</label>
        
                                        <input id="name" type="text" class="p-3 bg-gray-300 rounded form-input w-full @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" name="name" value="{{ old('name') }}" novalidate autocomplete="name" autofocus>
                                ...
                                <div class="flex flex-wrap mb-6">
                                    <label for="email" class="block text-gray-800 text-md mb-2">{{ __('E-Mail Address') }}</label>
                                        <input id="email" type="email" class="p-3 bg-gray-300 rounded form-input w-full @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" novalidate autocomplete="email">
                                ...
                                <div class="flex flex-wrap mb-6">
                                    <label for="password" class="block text-gray-700 text-md mb-2">{{ __('Password') }}</label>
                                        <input id="password" type="password" class="p-3 bg-gray-300 rounded form-input w-full @error('password') is-invalid @enderror" name="password" novalidate autocomplete="new-password">
                                ...
                                <div class="flex flex-wrap mb-6">
                                    <label for="url" class="block text-gray-700 text-md mb-2">{{ __('Pagina Web') }}</label>
        
                                        <input id="url" type="text" class="p-3 bg-gray-300 rounded form-input w-full @error('url') is-invalid @enderror" name="url" value="{{ old('url') }}" novalidate autocomplete="url" autofocus>
            ...
            <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
               <h1 class="text-gray-900 text-3xl">Eres reclutador?</h1>
